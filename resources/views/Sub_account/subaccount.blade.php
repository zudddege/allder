...
<body class="main-body app sidebar-mini">
				...
				<div class="row row-sm">
					<div class="col-xl-12">
						<div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <a class="btn btn-primary" style="position: absolute; left: 45;" href="{{url('/add_subaccount')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
											...
											<table class="table table-striped position-relative" id="my-table">
												...
												<tbody>
													<tr>
														...
														<td><a href="#" style="color: blue;"><u>ST00324</u></a></td>
														<td>erbert Riley</td>
														<td>t.olson@yahoo.com</td>
														<td>พงจิตร พิศมัย</td>
														<td>081-213-4215</td>
														<td>5 %</td>
														<td>5 %</td>
													...
													<tr>
														...
														<td><a href="#" style="color: blue;"><u>ST00324</u></a></td>
														<td>Terrence Schroeder</td>
														<td>e.myers@outlook.com</td>
														<td>พงจิตร พิศมัย</td>
														<td>081-213-4215</td>
														<td>0 %</td>
														<td>0 %</td>
	...
	<script>
		...
		$('.app-sidebar__toggle').click(function(){
        	...
        	setTimeout(function()  {table.columns.adjust().draw(); }, 230);
		})
		s
    </script>
