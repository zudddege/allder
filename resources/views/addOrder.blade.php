<html lang="en">
<head><style data-styles="">ion-icon{visibility:hidden}.hydrated{visibility:inherit}</style><style data-styles="">ion-icon{visibility:hidden}.hydrated{visibility:inherit}</style><style data-styles="">ion-icon{visibility:hidden}.hydrated{visibility:inherit}</style>
...
<script src="file:///C:/xampp/htdocs/html/assets/plugins/ionicons/ionicons/ionicons.z18qlu2u.js" data-resources-url="file:///C:/xampp/htdocs/html/assets/plugins/ionicons/ionicons/" data-namespace="ionicons"></script><style type="text/css" id="s./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./package/src/animation.scss-0">/**
 * @license
...
@keyframes eva-zoomIn {
  ...
  50% {
    opacity: 1; } }
</style><script src="file:///C:/xampp/htdocs/html/assets/plugins/ionicons/ionicons/ionicons.z18qlu2u.js" data-resources-url="file:///C:/xampp/htdocs/html/assets/plugins/ionicons/ionicons/" data-namespace="ionicons"></script><script src="file:///C:/xampp/htdocs/html/assets/plugins/ionicons/ionicons/ionicons.z18qlu2u.js" data-resources-url="file:///C:/xampp/htdocs/html/assets/plugins/ionicons/ionicons/" data-namespace="ionicons"></script>
		...
		<aside class="app-sidebar sidebar-scroll ps" >
			...
			<div class="main-sidemenu is-expanded">
				...
				<ul class="side-menu open" >
					...
					<li class="slide">
						<a class="side-menu__item" href="#"><span class="side-menu__label">เรียกคูเรียร์รับพัสดุ</span></a>
					</li>
					<li class="slide">
		...
		<div class="main-content app-content">
			...
			<div class="main-header sticky side-header nav nav-item" style="margin-bottom: -63px;">
				<div class="d-flex align-items-center">
					...
					<button type="button" class="btn btn-primary" >เรียกพนักงานเข้ามารับพัสดุ</button>
                    <button type="button" class="btn btn-primary" style="margin-left: 10px;">ระบุพนักงานเข้ารับพัสดุ</button>   
				</div>
			</div>
			<!-- /main-header -->
							...
							<div class="card">
								<div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="">
                                            <input class="form-control" type="text" value="{{ $order_no }}" name="order_no">
                                        </div>
                                        <a class="px-3" style="color:blue"><u>ใช้รหัสอัตโนมัติ</u></a>  
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row row-cols-12">
                                        ...
                                        <div class="col-6" style="border-right: 1px solid black;">
                                           ...
                                           <div class="px-4">
                                               <p class="mt-2 mb-1">ชื่อผู้ส่ง</p>
												   <input class="form-control" type="text" value="" name="send_name">
                                           </div>
                                            <div class="px-4">
                                            ...
                                            <div class="px-4">
                                                ...
                                                <textarea style="resize: none; width: 100%;" rows="4" class="border border-light" name="send_area"></textarea>
                                            </div>
                                            <div class="px-4">
                                                <p class="mt-2 mb-1">รายละเอียดที่อยู่</p>
                                                <textarea style="resize: none; width: 100%;" rows="4" class="border border-light" name="send_address"></textarea>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="px-4">
                                             ...
                                             <div class="px-4">
                                                 <p class="mt-2 mb-1">พื้นที่บริการ</p>
                                                 <textarea style="resize: none; width: 100%;" rows="4" class="border border-light" name = "recv_area"></textarea>
                                             </div>
                                             <div class="px-4">
                                                 <p class="mt-2 mb-1">รายละเอียดที่อยู่</p>
                                                 <textarea style="resize: none; width: 100%;" rows="4" class="border border-light" name = "recv_address"></textarea>
                                             </div>
                                    ...
                                    <div class="row px-2 mt-3">
                                        <div class="col-3">
                                            ...
                                            <select class="custom-select my-1 mr-sm-2 border-light" id="inlineFormCustomSelectPref" style="width: 100%; height: 35px;" name="categories">
												...
												<option value="8">รองเท้า/กระเป๋า</option>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="d-flex">
                                               <input class="form-control" type="text" value="" style="width: 100%;" name = "weight">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex">
                                                <input class="form-control" type="text" value="" style="width: 100%;" name = "width_size">
                                                <a class="mt-2 px-2">x</a>
                                                <input class="form-control" type="text" value="" style="width: 100%;" name = "length_size">
                                                <a class="mt-2 px-2">x</a>    
                                                <input class="form-control" type="text" value="" style="width: 100%;" name = "height_size">
						...
						<div class="col-4">
							<div class="card">
								<div class="card-body">
									...
									<div class="d-flex">
										<input type="checkbox" class="mt-1" name = "is_return_insurance">
										<p class="px-1">ประกันพัสดุดีดกลับ<br>
											<a class="text-muted">หากพัสดุถูกดีดกลับ จะไม่คิดค่าขนส่งดีดกลับ<br>ฉันได้อ่านและยอมรับข้อกำหนดใน <br>
											<a href="#" class="" style="color: blue;"><u>เงื่อนไขความคุ้มครองพัสดุดีดกลับ</u></a>
											<a class="text-muted">แล้ว</a></a>
										</p>
									</div>
									<div class="d-flex">
										<input type="checkbox" class="mt-1" name = "is_protect_insurance">
										<p class="px-1">ประกันคุ้มครองพัสดุ</p>
									</div>
									<div class="d-flex">
										<input type="checkbox" class="mt-1" name = "is_express_transport">
										<p class="px-1">SPEED<br>
											<a class="text-muted">คาดการณ์จัดส่งภายในวันที่<br>เพื่อรับรองประสิทธิภาพการจัดส่งพัสดุ กรุณาบุ๊คกิ๊งก่อนเวลา <br> ฉันได้อ่านและยอมรับข้อกำหนดใน <br>
											<a href="#" class="" style="color: blue;"><u>เงื่อนไขและข้อกำหนดของ SPEED</u></a>
											<a class="text-muted">แล้ว</a></a>
										</p>
									</div>
									<div class="d-flex">
										<input type="checkbox" class="mt-1" name = "is_damage_insurance">
										<p class="px-1">ประกันบรรจุภัณฑ์ภายนอกเสียหาย<br>
											<a class="text-muted">เมื่อบรรจุภัณฑ์ภายนอกเสียหายจะได้รับค่าชดเชย <br>และเคลมเต็ม
...
<div class="main-navbar-backdrop"></div><div class="main-navbar-backdrop"></div><div class="main-navbar-backdrop"></div></body></html>