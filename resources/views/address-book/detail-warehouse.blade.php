                        ...
                        <div class="card">
                            <div class="px-4 py-4">
                                ...
                                <div class="d-flex justify-content-center">
                                    <a class="btn btn-primary my-2" id="submit-button" disabled="true" href="{{url('books/warehouse/edit?id='.$warehouse->id)}}" style="color: white;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-down-left" viewBox="0 0 16 16">
