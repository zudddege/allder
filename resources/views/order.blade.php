		...
		<aside class="app-sidebar sidebar-scroll ps" >
			...
			<div class="main-sidemenu is-expanded">
				...
				<ul class="side-menu open" >
					...
					<li class="slide">
						<a class="side-menu__item" data-bs-toggle="slide" href="#"><span class="side-menu__label">เรียกคูเรียร์รับพัสดุ</span></a>
					</li>
					<li class="slide">
						...
						<div class="card">
                            ...
                            <div class="card-header pb-0">
                                <ul class="nav main-nav-line">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="sidebar.html">รายการเตรียมจัดส่ง</a></li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="add.html">รายการจัดส่งแล้ว</a></li>
                                </ul>                                            
                            </div>
							<div class="jumps-prevent" style="padding-top: 10px;"></div>
                            <div class="card-body">
                                
								<a class="btn btn-primary" style="position: absolute; left: 45;" href="{{url('/add_order')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                </svg>  สร้างรายการ
								</a>

                                <a type="file" class="btn btn-info" style="position: absolute; left: 180;" href="{{url('/import')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upload" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                    <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
                                </svg>   นำเข้าข้อมูล</a>
                                <a class="btn btn-link" style="position: absolute; left: 320;" href="{{url('/users/export')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
							...
							<div class="row px-2 mb-3">
								...
								<div class="col-4">
									<div class="mb-1">ค้นหา<a class="text-muted px-2">เลขออเดอร์, เลขพัสดุ, เบอร์โทรศัพท</a></div>
									<div class="d-flex ">
										<div class="">
											<input class="form-control" type="text" value="">
										</div>
										<button type="button" class="btn btn-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-layout-three-columns" viewBox="0 0 16 16">
							...
							<div class="px-2 ">
								<table class="table table-striped position-relative" id="my-table">
									...
									<tbody>
										...
										<td>{{$row['recv_tel']}}</td>
										<td>{{$row['categories']}} <br> {{$row['weight']}}  kg / {{$row['width_size']}} x {{$row['length_size']}} x {{$row['height_size']}} cm</td>
										<td>{{$row['cod']}}</td>
										<td>{{$row['cod']}}</td>
